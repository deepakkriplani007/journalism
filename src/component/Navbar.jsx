...
import Imagesrc1 from "../assets/arun.png";
import Imagesrc2 from "../assets/jour.png";
// import "./App.css";
      ...
      <nav className="relative py-2 bg-[#162242] z-50">
        <div className="container mx-auto">
          <div className="flex items-center relative">
            <img
              className="inline-block text-lg font-bold h-6"
              src={Imagesrc1}
              alt=""
              width="auto"
            />
            <Link className="inline-block text-lg font-bold" to="/">
              <img className="h-24" src={Imagesrc} alt="" width="auto" />
            </Link>
            <img
              ...
              width="auto"
            />
            <span className="text-[48px] flex self-center italic"></span>
            ...
            <ul className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 hidden xl:flex lg:w-auto lg:space-x-12">
              <li className="group relative">
                <Link
                  className="inline-block text-xl text-gray-100 hover:text-orange-900 font-medium"
                  to="header"
                >
                  Home
                </Link>
        ...
        <nav className="relative flex flex-col py-6 px-10 w-full h-full bg-[#162242] border-r overflow-y-auto">
          ...
          <div>
            <ul className="mb-2">
              ...
              <li>
                <Link
                  className="block py-4 px-5 text-gray-100  hover:text-orange-900 hover:bg-orange-50 rounded-lg"
                  to="header"
                >
                  Home
                </Link>
            ...
            <div className="py-8 px-6 mb-6 border-t border-b border-gray-200">
              <Link
                className="flex items-center text-xl font-semibold text-orange-900 hover:text-orange-600"
                to="/"
              >
                <svg
                  width="18"
            ...
            <div className="flex px-6 mb-16 items-center">
              <Link
                className="inline-block py-3 px-4 text-xl font-semibold text-orange-900 hover:text-white border border-gray-300 hover:border-orange-600 hover:bg-orange-900 rounded-md transition duration-200"
                to="footer"
              >
                Enroll Now
              </Link>
